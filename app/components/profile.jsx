...
const Profile = () => {
	return (
		<div className="h-screen bg-sec text-pri">
			<div className="p-4 space-y-9 sm:p-6 sm:rounded-lg">
				<h1 className="text-pri p-2 text-center text-4xl mt-4">Huntek</h1>
			</div>
			<div className="w-full h-full px-4 mb-2 grid grid-cols-1">
				<div className="w-full">
					...
					<div className="p-4 rounded-lg flex text-pri flex-row justify-between">
						...
						<Image width={32} height={32} src="/utils/pencil_huntek.svg" className="	text-pri hover:opacity-70 mr-8" />
					</div>
