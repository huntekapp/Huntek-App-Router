...
const Profile = ({ user, closeProfile, setCloseProfile }) => {
  return (
    <section className="w-full h-screen text-pri flex flex-col">
      ...
      <article className="w-full h-full p-8 flex flex-col justify-evenly items-center">
        <div className="w-full h-2/4 flex flex-col justify-around items-center">
        ...
        <div className="w-full h-full mt-5  text-base flex flex-col justify-around items-center">
      ...
      <article className="w-full h-[20%] mb-3  px-8  text-pri-500 flex flex-col justify-evenly items-center">
