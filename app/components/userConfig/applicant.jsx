        ...
        <main className="w-full max-w-md h-[80%] carousel rounded-box text-pri bg-pri-100 border-2 hidd">
          <section
            ...
            <div className="h-1/4 flex flex-col justify-evenly items-center">
              <label className="w-fit h-16 px-4 flex flex-col justify-center items-center bg-sec text-pri rounded-lg shadow-lg cursor-pointer hover:bg-pri hover:text-sec">
