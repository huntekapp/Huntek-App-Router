			...
			<section className="w-full min-h-screen bg-sec grid grid-cols-1 gap-4 p-2 place-content-center text-start rounded-md ">
				...
				<div className="w-full mb-2">
					...
					<select
						...
						<option value={"Universidad Autónoma de Nuevo León (UANL)"}>
						...
						<option value={"Universidad Autónoma de Guadalajara (UAG)"}>
						...
						<option value={"Universidad del Valle de Atemajac (UNIVA)"}>
						...
						<option value={"Instituto Tecnológico de Hermosillo (ITH)"}>
				...
				<div className="w-full mb-2">
					...
					<select
						...
						<option value="Ingeniería de Sistemas de Telecomunicación">
