...
const JobSkills = ({jobProps, handleChange}) => {
	const options = [
	...
	useEffect(() => {
		const ski = selectedOption.map((opt) => opt.value);
		handleChange({
			target: {
				name: "skills", 
				value: {
					value: selectedOption ? ski : "",
					determinant: true
				}
			},
		});
	...
	return (
		<div className="w-full mb-2">
			...
			<Select
				...
				menuPlacement="auto"
				placeholder="Selecciona hasta 4 habilidades"
