...
const Interviews = () => {
  return (
    <article className="w-full h-1/5 mb-20 px-4 flex flex-col justify-around">
      ...
      <div className="w-full h-[70%] px-4  text-xs xs:text-sm text-pri border rounded-xl shadow-md flex  justify-start items-center">
        <span className="w-14 h-[3.5rem] flex-shrink-0 font-bold text-sm border-2 border-pri rounded-full center">18 SEP</span>
        <p className="text-md ml-6 sm:text-lg btn-ghost hover:bg-pri/70 bg-pri btn flex-shrink text-sec font-semibold ">
