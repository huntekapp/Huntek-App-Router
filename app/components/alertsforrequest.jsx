export const AlertSuccess = ({alertTitle, alertBody, setSuccessReq}) => {
	return (
		<div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded absolute top-2 w-2/4" role="alert">
...
export const AlertError = ({alertTitle, alertBody, setErrorCatched}) => {
	return (
		<div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded absolute top-2 w-2/4" role="alert">
			<strong className="font-bold">{alertTitle}</strong>
			<span className="block sm:inline">{alertBody}</span>
